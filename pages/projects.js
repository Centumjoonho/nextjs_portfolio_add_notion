...
export default function Projects({ projects }) {
   // 1) Notion 에러 응답이면 여기서 바로 화면 리턴
   if (projects?.object === "error") {
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 mb-10">
          ...
          <p className="mt-2 text-red-500">
            Notion API 오류: {projects.message} (status: {projects.status})
          </p>
  ...
  const projectResults = Array.isArray(projects.results) ? projects.results : [];
  return (
    <>
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 mb-10">
